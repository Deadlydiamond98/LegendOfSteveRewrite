...
public class BombfishEntityModel<T extends BombfishEntity> extends EntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData head = bodyFront.addChild("head", ModelPartBuilder.create().uv(0, 49).cuboid(-4.0F, -6.7F, -3.5F, 8.0F, 6.0F, 8.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 7.0F, -9.5F));
		...
		ModelPartData upperTeeth_r1 = upperJaw.addChild("upperTeeth_r1", ModelPartBuilder.create().uv(28, 6).cuboid(-4.0F, -3.0F, -4.0F, 8.0F, 3.0F, 8.0F, new Dilation(0.0625F)), ModelTransform.of(0.0F, 1.9F, -4.0F, 0.2618F, 0.0F, 0.0F));
		...
		ModelPartData upperTeeth_r2 = lowerJaw.addChild("upperTeeth_r2", ModelPartBuilder.create().uv(28, 18).cuboid(-4.0F, -3.0F, -4.0F, 8.0F, 2.0F, 8.0F, new Dilation(0.0625F)), ModelTransform.of(0.0F, 2.4F, -5.1F, -0.2182F, 0.0F, 0.0F));
