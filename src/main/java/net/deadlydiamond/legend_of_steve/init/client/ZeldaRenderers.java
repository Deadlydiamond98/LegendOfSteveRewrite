...
import net.deadlydiamond.legend_of_steve.client.rendering.entity.projectile.bomb.WaterBombRenderer;
...
public class ZeldaRenderers {
    ...
    private static void registerEntityRenderers() {
        EntityRendererRegistry.register(ZeldaEntityTypes.BOMBFISH, BombfishEntityRenderer::new);
        ...
        EntityRendererRegistry.register(ZeldaEntityTypes.WATER_BOMB, WaterBombRenderer::new);
    }
    ...
    private static void registerModelLayers() {
        ...
        EntityModelLayerRegistry.registerModelLayer(BombfishEntityModel.LAYER_LOCATION, BombfishEntityModel::getTexturedModelData);
