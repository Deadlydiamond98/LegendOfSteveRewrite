...
public class MasterBarrelBlockEntity extends LootableContainerBlockEntity  {
    private DefaultedList<ItemStack> inventory = DefaultedList.ofSize(54, ItemStack.EMPTY);
    private final ViewerCountManager stateManager = new ViewerCountManager() {
        @Override
        protected void onContainerOpen(World world, BlockPos pos, BlockState state) {
            MasterBarrelBlockEntity.this.playSound(state, ZeldaSounds.MASTER_BARREL_OPEN);
            MasterBarrelBlockEntity.this.setOpen(state, true);
        }

        @Override
        protected void onContainerClose(World world, BlockPos pos, BlockState state) {
            MasterBarrelBlockEntity.this.playSound(state, ZeldaSounds.MASTER_BARREL_CLOSE);
            MasterBarrelBlockEntity.this.setOpen(state, false);
        }
        ...
        protected boolean isPlayerViewing(PlayerEntity player) {
            if (player.currentScreenHandler instanceof GenericContainerScreenHandler container) {
                ...
                return inventory == MasterBarrelBlockEntity.this;
            } else {
                return false;
            }
        }
    ...
    public MasterBarrelBlockEntity(BlockPos pos, BlockState state) {
        super(ZeldaBlockEntities.MASTER_BARREL, pos, state);
    }
