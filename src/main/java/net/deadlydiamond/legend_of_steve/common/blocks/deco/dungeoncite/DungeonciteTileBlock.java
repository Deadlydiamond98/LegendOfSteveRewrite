...
public class DungeonciteTileBlock extends TileBlock implements IAdvancementNeeded {
    public static final BooleanProperty PLAYERMADE = KoalaLibBlockProperties.PLAYER_MADE_PROPERTY;
    private final String advancementID;

    public DungeonciteTileBlock(AbstractBlock.Settings settings, String advancementID) {
        super(settings);
