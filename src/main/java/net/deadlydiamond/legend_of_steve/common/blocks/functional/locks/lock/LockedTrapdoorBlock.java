...
public class LockedTrapdoorBlock extends TrapdoorBlock implements ILockedBlock, BlockEntityProvider {
    private final TagKey<Item> keyTag;

    public LockedTrapdoorBlock(Settings settings, TagKey<Item> keyTag) {
