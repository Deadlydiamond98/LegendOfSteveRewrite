...
public class ZeldaWorldGenDatagen extends FabricDynamicRegistryProvider {
    public ZeldaWorldGenDatagen(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
