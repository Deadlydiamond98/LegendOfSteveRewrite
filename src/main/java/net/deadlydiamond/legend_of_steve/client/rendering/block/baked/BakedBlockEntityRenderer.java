...
/*
 * This class is part of The Legend of Steve, but it uses many parts of code from Glowcase by the Modfest Team.
 * The original project is licensed under CC0 1.0 Universal
 * For more details, https://github.com/ModFest/glowcase
 */
...
public abstract class BakedBlockEntityRenderer<T extends BlockEntity> implements BlockEntityRenderer<T> {
    ...
    // TODO: This needs to be run on a seperate thread! Small stuttering can occur when placing &
    //  breaking blocks when there's a large count!!
    ...
    public static class Manager {
        ...
        public static void render(WorldRenderContext wrc) {
            wrc.profiler().push("legend_of_steve:baked_block_entity_rendering");
