...
public class DungeonTableRecipe implements Recipe<RecipeInputInventory> {
    ...
    public DungeonTableRecipe(Identifier id, String group, CraftingRecipeCategory category, int width, int height,
    ...
    public static class Serializer implements RecipeSerializer<DungeonTableRecipe> {
        ...
        @Override
        public DungeonTableRecipe read(Identifier identifier, JsonObject jsonObject) {
            ...
            return new DungeonTableRecipe(identifier, string, craftingRecipeCategory, i, j, defaultedList, itemStack, bl, bindableId, manaCost);
        }

        @Override
        public DungeonTableRecipe read(Identifier identifier, PacketByteBuf packetByteBuf) {
        ...
        @Override
        public void write(PacketByteBuf packetByteBuf, DungeonTableRecipe shapedRecipe) {
