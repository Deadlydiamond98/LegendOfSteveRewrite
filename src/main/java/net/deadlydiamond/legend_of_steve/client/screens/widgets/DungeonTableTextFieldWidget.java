package net.deadlydiamond.legend_of_steve.client.screens.widgets;
...
public class DungeonTableTextFieldWidget extends ClickableWidget implements Drawable {
    ...
    public DungeonTableTextFieldWidget(TextRenderer textRenderer, int x, int y, int width, int height, Text text) {
        this(textRenderer, x, y, width, height, null, text);
    }

    public DungeonTableTextFieldWidget(TextRenderer textRenderer, int x, int y, int width, int height, @Nullable TextFieldWidget copyFrom, Text text) {
    ...
    public void renderButton(DrawContext context, int mouseX, int mouseY, float delta) {
        if (this.isVisible()) {
            if (this.drawsBackground()) {
                int i = this.isFocused() ? -1 : 0xFF08290b;
                context.fill(this.getX() - 1, this.getY() - 1, this.getX() + this.width + 1, this.getY() + this.height + 1, i);
                context.fill(this.getX(), this.getY(), this.getX() + this.width, this.getY() + this.height, 0xFF144c15);
            }
