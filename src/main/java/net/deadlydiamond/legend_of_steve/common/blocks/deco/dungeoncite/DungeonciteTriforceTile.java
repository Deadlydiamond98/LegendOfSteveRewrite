...
public class DungeonciteTriforceTile extends TriforceTileBlock implements IAdvancementNeeded {
    public static final BooleanProperty PLAYERMADE = KoalaLibBlockProperties.PLAYER_MADE_PROPERTY;
    private final String advancementID;

    public DungeonciteTriforceTile(AbstractBlock.Settings settings, String advancementID) {
        super(settings);
